      ...
      <div class="relative">
        <div class="flex items-center justify-between px-4 py-6 mx-auto max-w-7xl sm:px-6 md:justify-start md:space-x-10 lg:px-8">
          ...
          class="-my-2 -mr-2 md:hidden">
            ...
            bg-primary hover: 
            hover:bg-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-yellow-500" aria-expanded="false">
            ...
            class="px-5 pt-5 pb-6">
              ...
              >
                <nav class="grid grid-cols-1 gap-7">
                  ...
                  <a href="#services" class="flex items-center p-3 -m-3 rounded-lg hover:bg-gray-50 text-white">
                    <div class="ml-4 text-base font-medium text-white hover:text-black">
                      Party Services
                    </div>
                  </a>
  
                  <a href="#about-me" class="flex items-center p-3 -m-3 rounded-lg hover:bg-gray-50 text-white">
                    <div class="ml-4 text-base font-medium text-white hover:text-black">
                      About Me
                    </div>
                  </a>
