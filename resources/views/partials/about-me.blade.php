      ...
      <div class="mt-8 lg:grid lg:grid-cols-2 lg:gap-8">
          ...
          <div class="relative mx-auto text-base max-w-prose lg:max-w-none">
            <figure>
              ...
              <figcaption class="flex mt-3 text-sm text-white">
                ...
                <span class="ml-2">Rocio the Easter bunny</span>
              </figcaption>
            </figure>
          </div>
        </div>
        <div class="mt-8 text-white lg:mt-0">
          <div class="mx-auto text-base max-w-prose lg:max-w-none text-shadow">
            <p class="text-lg ">Sagittis scelerisque nulla cursus in enim consectetur quam. Dictum urna sed consectetur neque tristique pellentesque. Blandit amet, sed aenean erat arcu morbi.</p>
          </div>
