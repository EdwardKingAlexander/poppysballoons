...
<div class="min-h-screen bg-accent-one">
    ...
    <div class="overflow-hidden">
      ...
      <!-- Contact section -->
      <section class="relative bg-accent-one" aria-labelledby="contact-heading">
        <div class="absolute w-full h-1/2 bg-warm-gray-50" aria-hidden="true"></div>
        <!-- Decorative dot pattern -->
        <div class="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <svg class="absolute top-0 right-0 z-0 transform translate-x-1/2 -translate-y-16 sm:translate-x-1/4 md:-translate-y-24 lg:-translate-y-72" width="404" height="384" fill="none" viewBox="0 0 404 384" aria-hidden="true">
            <defs>
        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div class="relative shadow-xl bg-accent-one">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3">
              <!-- Contact information -->
              <div class="relative px-6 py-10 overflow-hidden bg-gradient-to-b bg-primary to-bg-secondary sm:px-10 xl:p-12">
                ...
                <p class="max-w-3xl mt-6 text-base text-teal-50">For all party requests and information, please contact us via email or phone.</p>
                <dl class="mt-8 space-y-6">
                  <dt><span class="sr-only">Phone number</span></dt>
                  <dd class="flex text-base text-teal-50">
                    <!-- Heroicon name: outline/phone -->
                    <svg class="flex-shrink-0 w-6 h-6 text-yellow-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                ...
                <ul role="list" class="flex mt-8 space-x-12">
                  <li>
                    <a class="text-yellow-500 hover:text-teal-100" href="#">
